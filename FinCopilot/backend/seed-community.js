...
async function seed() {
    try {
        ...
        // Find an existing user or create a demo one
        ...
        if (!user) {
            ...
            try {
                ...
                console.error('Failed to save demo user:', saveErr.message);
                if (saveErr.errors) console.error('Validation errors:', Object.keys(saveErr.errors));
                throw saveErr;
            }
        }
        ...
        try {
            ...
            console.error('Failed to insert demo posts:', postErr.message);
            throw postErr;
        }
