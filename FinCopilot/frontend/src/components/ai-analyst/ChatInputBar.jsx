...
import { Send, Paperclip, Plus, HelpCircle, X } from 'lucide-react'

export const ChatInputBar = ({ onSendMessage, onNewChat, isLoading }) => {
  ...
  return (
    <div className="bg-black border-t border-dark-gray p-4 space-y-3">
      ...
      {uploadedFile && (
        <div className="flex items-center gap-3 px-4 py-3 bg-dark-gray rounded-lg border border-neon-green/30">
          ...
          <button
            ...
            className="p-1 hover:bg-black rounded transition-colors text-gray-400 hover:text-red-400"
          >
            <X size={16} />
          </button>
        </div>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            rows="1"
            className="w-full px-4 py-3 pr-20 rounded-lg bg-white border border-dark-gray hover:border-purple-accent focus:border-neon-green text-black placeholder-gray-500 focus:outline-none transition-colors resize-none"
          ...
          <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
            <button
              ...
              className="p-2 text-gray-400 hover:text-neon-green transition-colors hover:bg-black rounded"
              title="Attach file"
            >
              <Paperclip size={18} />
            </button>
            <button
              ...
              className={`p-2 rounded transition-colors ${isLoading || (!message.trim() && !uploadedFile)
                  ...
                  : 'text-black hover:text-neon-green hover:bg-gray-100/10'
                }`}
            >
              <Send size={18} />
            </button>
      ...
      {/* Footer */}
      <div className="flex items-end justify-between text-xs text-gray-500 px-2">
        <p>Press Shift+Enter for new line</p>
        <a href="#" className="text-purple-accent hover:text-neon-green transition-colors font-medium">
          Stocko Guide
        </a>
      </div>
    </div>
