...
export const StockChart = ({ stockSymbol = 'BAJFINANCE', data }: StockChartProps) => {
                ...
                <div className="bg-[#1e1e1e] border border-gray-700 rounded-lg p-3 text-xs shadow-xl">
                    ...
                    {data.event && (
                        <div className="mt-2 flex items-center gap-2">
                            <span className="w-4 h-4 flex items-center justify-center rounded-full text-[10px] text-white font-bold" style={{ backgroundColor: data.color }}>
                                {data.event}
                            </span>
            ...
            <g>
                {payload.event && (
                    <g transform={`translate(${cx}, ${cy})`}>
                        <circle cx={0} cy={0} r={10} fill={payload.color} stroke="#1e1e1e" strokeWidth={2} />
