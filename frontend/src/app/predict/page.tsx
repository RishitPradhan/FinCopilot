    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-20">
            <div className="flex justify-between items-end">
                ...
                <div className="flex items-center space-x-3 bg-[#111827] border border-[#1f2937] p-1 px-3 rounded-full">
                    <History className="h-4 w-4 text-gray-500" />
                    <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Historical Accuracy: </span>
                    <span className="text-xs font-mono text-[#00d4ff] font-bold">78.2%</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card className="lg:col-span-2 bg-[#111827] border-[#1f2937] overflow-hidden">
                    <CardHeader className="flex flex-row items-center justify-between border-b border-[#1f2937]/50">
                        <div className="flex items-center space-x-4">
                            <Select value={selectedStock} onValueChange={setSelectedStock}>
                                <SelectTrigger className="w-[180px] bg-[#0a0f1e] border-[#1f2937] text-white font-bold">
                        ...
                        <div className="flex space-x-2">
                            <Badge variant="outline" className="border-[#1f2937] text-[#10b981]">+2.45%</Badge>
                            <Badge variant="outline" className="border-[#1f2937] text-gray-500 flex items-center">
                    ...
                    <CardContent className="pt-6 h-[400px]">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={chartData}>
                                ...
                                />
                                <Tooltip
                                    contentStyle={{ backgroundColor: '#0a0f1e', border: '1px solid #1f2937', borderRadius: '8px' }}
                ...
                <Card className="bg-[#111827] border-[#1f2937] flex flex-col">
                    ...
                    <CardContent className="flex-1 space-y-8">
                        <div className="flex gap-4">
                            <Button
                                ...
                                variant="outline"
                                className={cn(
                                    "flex-1 h-20 flex flex-col border-[#1f2937] bg-[#0a0f1e] hover:bg-emerald-500/10 hover:border-emerald-500 transition-all",
                                    prediction === 'UP' && "border-emerald-500 bg-emerald-500/10 ring-1 ring-emerald-500"
                                )}
                            >
                                <ArrowUp className={cn("h-6 w-6 mb-1", prediction === 'UP' ? "text-emerald-500" : "text-gray-500")} />
                                <span className={cn("text-xs font-bold uppercase", prediction === 'UP' ? "text-emerald-500" : "text-gray-500")}>Bullish</span>
                            </Button>
                            <Button
                                onClick={() => setPrediction('DOWN')}
                                variant="outline"
                                className={cn(
                                    "flex-1 h-20 flex flex-col border-[#1f2937] bg-[#0a0f1e] hover:bg-red-500/10 hover:border-red-500 transition-all",
                                    prediction === 'DOWN' && "border-red-500 bg-red-500/10 ring-1 ring-red-500"
                                )}
                            >
                                <ArrowDown className={cn("h-6 w-6 mb-1", prediction === 'DOWN' ? "text-red-500" : "text-gray-500")} />
                                <span className={cn("text-xs font-bold uppercase", prediction === 'DOWN' ? "text-red-500" : "text-gray-500")}>Bearish</span>
                            </Button>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-sm font-mono text-[#00d4ff] font-bold">{confidence[0]}%</span>
                            </div>
                            <Slider
                                value={confidence}
                        ...
                        <div className="p-4 rounded-xl bg-blue-500/5 border border-blue-500/10 flex items-start space-x-3">
                    ...
                    <CardFooter className="pt-6 border-t border-[#1f2937]/50">
                        <Button
                            className="w-full bg-[#00d4ff] text-[#0a0f1e] hover:bg-[#00b8e6] font-bold h-12"
            ...
            {showResult && (
                <Card className="bg-emerald-500/5 border border-emerald-500/20 animate-in slide-in-from-top-4 duration-500">
                    <CardHeader className="flex flex-row items-center space-x-4">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-emerald-500/70 font-medium">You predicted {prediction === 'UP' ? 'Bullish' : 'Bearish'} with {confidence[0]}% confidence.</CardDescription>
                        </div>
                    </CardHeader>
                    <CardContent className="grid md:grid-cols-2 gap-8 items-center border-t border-emerald-500/10 pt-6">
                        <div className="space-y-4">
                            <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest flex items-center">
                                <Zap className="h-4 w-4 mr-2 text-yellow-400" /> AI Perspective
                            </h4>
                            <p className="text-sm text-gray-300 leading-relaxed">
                                Our AI model currently predicts an <span className="text-emerald-400 font-bold underline">UPWARD</span> movement for {selectedStock} with <span className="text-[#00d4ff] font-bold">82% confidence</span>.
                        ...
                        <div className="flex gap-4">
                            <div className="flex-1 p-4 rounded-xl bg-[#0a0f1e] border border-[#1f2937] text-center">
                                <p className="text-[10px] font-bold text-gray-500 uppercase mb-1">Your Call</p>
                                <p className={cn("text-xl font-bold", prediction === 'UP' ? "text-emerald-500" : "text-red-500")}>
                                    {prediction}
                                </p>
                            </div>
                            <div className="flex-1 p-4 rounded-xl bg-[#0a0f1e] border border-[#1f2937] text-center">
                                <p className="text-[10px] font-bold text-gray-500 uppercase mb-1">AI Call</p>
                                <p className="text-xl font-bold text-[#00d4ff]">UP</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {historyData.map((item) => (
                                <TableRow key={item.id} className="border-[#1f2937] hover:bg-[#1f2937]/30">
                                    ...
                                    <TableCell>
                                        <span className={cn(
                                            ...
                                            item.userPred === 'UP' ? "text-emerald-400" : "text-red-400"
                                        )}>
                                    ...
                                    <TableCell>
                                        <span className={cn(
                                            "flex items-center text-xs font-bold",
                                            item.aiPred === 'UP' ? "text-emerald-400" : "text-red-400"
                                        )}>
                                    ...
                                    <TableCell>
                                        <span className={cn(
                                            "flex items-center text-xs font-bold",
                                            item.actual === 'UP' ? "text-emerald-400" : "text-red-400"
                                        )}>
